...
[![Live Deployment](https://img.shields.io/badge/Live_Demo-View_Project-success?style=for-the-badge&logo=vercel)](https://zorvyn-mauve.vercel.app/)
...
Note on Data: All mock data initialized in the application is based on Indian contexts (INR ₹, local merchants) to demonstrate localization capability. If you log in as an Admin, everything is immediately mutable, so feel free to add your own data!
